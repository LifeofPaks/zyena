...
const ChatIcon = () => {
  return (
    ...
    >
      ...
      <circle cx="30.5" cy="25.5" r="1.5"></circle>
      <circle cx="17.5" cy="25.5" r="1.5"></circle>
      <path d="m44,23h-1v13h1c1.657,0,3-1.343,3-3v-7c0-1.657-1.343-3-3-3Z"></path>
      <path d="m5,23h-1c-1.657,0-3,1.343-3,3v7c0,1.657,1.343,3,3,3h1v-13Z"></path>
    </svg>
  );
};
