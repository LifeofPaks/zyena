      ...
      <div className="lg:!px-0 !px-6">
        ...
        <div className="reviewCarousel !mt-12">
          <Slider {...settings}>
            {reviewData.map((data) => (
              <span
                className=" shadow-lg !p-4 rounded-2xl lg:h-[220px] h-[200px]"
                key={data.id}
              >
                <span className="">
                  <span className="flex items-center gap-2">
                    ...
                    />
                    <span className="">
                      <h2 className="!text-[13px] lg:!text-[15px]">
                        {data.name}
                      </h2>
                      <span className="flex items-center gap-1">
                        ...
                        <p className="!text-[11px] lg:!text-[13px] text-gray-500">
                          February 6, 2025
                        </p>
                      </span>
                    </span>
                ...
                <p className="desc !text-[12px] lg:!text-[14px] !mt-2 text-gray-800">
                  {data.desc}
                </p>
              </span>
            ))}
